...
<body>
    <div class="container">
        ...
        <div class="subtitle">Live data from InfinityFree Database</div>
            ...
            try {
                ...
                const html = `
                    <div class="stats-grid">
                        ...
                        <div class="stat-card">
                            <div class="stat-number">${examsData.length}</div>
                    ...
                    <div class="section">
                        <h2 class="section-title">📚 Exams (${examsData.length})</h2>
                        <div class="table-wrapper">
                            <table>
                                <thead><tr><th>ID</th><th>Exam Code</th><th>Exam Name</th></tr></thead>
                                <tbody>
                                    ${examsData.map(e => `<tr><td>${e.id}</td><td><strong>${e.exam_code}</strong></td><td>${e.exam_name}</td></tr>`).join('')}
                                    ${examsData.length === 0 ? '<tr><td colspan="3">No exams found</td></tr>' : ''}
                                </tbody>
                            </table>
                        </div>
                    </div>
